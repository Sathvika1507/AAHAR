...
public class changePasswordActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //text-view
        findViewById(R.id.textViewYouAreNotAuthorized);
        //AppCompact-button
    ...
    private void reAuthenticateUser(FirebaseUser firebaseUser) {
        buttonReAuthenticate.setOnClickListener(view -> {
            userPwdCurr= Objects.requireNonNull(editTextPwdCurr.getText()).toString();
    ...
    private void changePwd(FirebaseUser firebaseUser) {
        ...
        String userPwdNew= Objects.requireNonNull(editTextPwdNew.getText()).toString();
        String userPwdConfirmNew= Objects.requireNonNull(editTextPwdConfirmNew.getText()).toString();
        String passwordVal = "^" +
