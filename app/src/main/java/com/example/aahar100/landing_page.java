...
public class landing_page extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        buttonLogin.setOnClickListener(view -> {
            ...
            if(!validateEmail() | !validatePassword()){
                ...
                String textEmail = Objects.requireNonNull(editTextLoginEmail.getText()).toString();
                String textPwd = Objects.requireNonNull(editTextLoginPwd.getText()).toString();
    ...
    private void loginUser(String email, String pwd) {
        authProfile.signInWithEmailAndPassword(email, pwd).addOnCompleteListener(landing_page.this, task -> {
    ...
    private Boolean validatePassword() {
        String val = Objects.requireNonNull(editTextLoginPwd.getText()).toString();
        String passwordVal = "^" +
