...
public class History extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        FirebaseRecyclerOptions<ReadWriteUserHistory> options=new FirebaseRecyclerOptions.Builder<ReadWriteUserHistory>()
                .setQuery(FirebaseDatabase.getInstance().getReference().child("History").child(Objects.requireNonNull(FirebaseAuth.getInstance().getCurrentUser()).getUid()),ReadWriteUserHistory.class).build();
