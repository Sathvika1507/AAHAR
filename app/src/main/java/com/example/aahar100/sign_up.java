...
public class sign_up extends AppCompatActivity {
    ...
    private void registerUser(String textFullName, String textEmail, String textMobile, String textPwd, String ignoredTextConfirmPwd) {
        FirebaseAuth auth = FirebaseAuth.getInstance();
        //create user profile
        auth.createUserWithEmailAndPassword(textEmail,textPwd).addOnCompleteListener(sign_up.this, task -> {
